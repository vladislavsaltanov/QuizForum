...
# Побочка: «один/одна»-местоимение («одна и та же» -> «1 и та же») тоже оцифровывается;
# измеренный сдвиг — только в сторону review (set2-09: positive -> partial), тихих false нет.
NUM_WORDS = {
    "ноль": 0,
